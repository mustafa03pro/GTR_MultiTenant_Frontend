...
const BestSellingReport = () => {
    ...
    const fetchReport = async () => {
        ...
        try {
            ...
            const response = await axios.get(`${API_URL}/pos/reports/best-selling-report`, {
                headers: { Authorization: `Bearer ${token}` },
                params: params
            });
    ...
    const exportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "Best Selling Report");
        XLSX.writeFile(workbook, "Best_Selling_Report.xlsx");
    };
    ...
    return (
        <div className="p-4 bg-gray-50 min-h-screen font-sans">
            <h1 className="text-2xl font-bold mb-6 text-gray-800">Best Selling items</h1>

            {/* Filters */}
            <div className="bg-white p-6 rounded-lg shadow mb-6 border border-gray-100">
                <h3 className="text-blue-900 font-semibold mb-4">Best Selling items</h3>
            ...
            <div className="bg-white rounded-lg shadow border border-gray-100 overflow-hidden">
                <div className="p-4 border-b border-gray-200 flex justify-between items-center bg-gray-50">
                    <h2 className="text-lg font-semibold text-blue-900">
                        Best Selling items - {stores.find(s => s.id == filters.storeId)?.name || 'All Branches'} from {filters.fromDate} to {filters.toDate}
                    </h2>
